  ...
  return (
    <div className="h-full w-full space-y-8 p-8">
      <HeaderTitle
        ...
        headerTitle="Dated and Signed Corporate Structure chart of Company Ownership and Control Structure"
      />
      <Form
        layout="vertical"
        autoComplete="off"
        ...
        <Upload
          ...
          label="Upload Corporate Structure Chart"
          className="w-48"
        />
...
export default memo(CorporateStructureChart);
