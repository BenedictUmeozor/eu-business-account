...
const RegisterOfDirectorsUpload = ({
  back,
  next,
}: {
  back: () => void;
  ...
  return (
    <div className="h-full w-full space-y-8 p-8">
      <HeaderTitle
        ...
        headerTitle="Current Register of Directors"
      />
      <Form
        layout="vertical"
        autoComplete="off"
        ...
        <Upload
          ...
          label="Upload current Register of Directors"
          className="w-48"
        />
...
export default memo(RegisterOfDirectorsUpload);
