  ...
  return (
    <div className="h-full w-full space-y-8 p-8">
      <HeaderTitle
        ...
        headerTitle="Evidence of Listing on a reputable stock exchange"
      />
      <Form
        layout="vertical"
        autoComplete="off"
        ...
        <Upload
          ...
          label="Upload Evidence of Listing"
          className="w-48"
        />
...
export default memo(EvidenceOfListingUpload);
