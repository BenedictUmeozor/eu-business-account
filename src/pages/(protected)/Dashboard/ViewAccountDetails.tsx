...
export type AccountDetailsRefObject = {
  openModal: (currency: string) => void;
};

const AccountDetails = forwardRef<AccountDetailsRefObject>((_props, ref) => {
  ...
  const country = useMemo(() => {
    ...
    return CURRENCIES.find(c => c.currencyCode === currency)?.countryCode;
  }, [currency]);
          ...
          <div className="rounded-xl bg-primary-50 border border-dashed border-primary-400 p-4 space-y-4">
            <div className="flex items-center justify-start gap-2">
              ...
              <p className="text-primary">
                Local Payments only. For international payments, please refer to
                the SWIFT details.
              </p>
            </div>
            <div className="flex items-center justify-start gap-2">
