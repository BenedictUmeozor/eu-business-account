...
const AuditedFinancialStatementUpload = ({
  back,
  next,
}: {
  back: () => void;
  ...
  return (
    <div className="h-full w-full space-y-8 p-8">
      <HeaderTitle
        ...
        headerTitle="Audited Financial Statements for the Last Three(3) Years"
      />
      <Form
        layout="vertical"
        autoComplete="off"
...
export default memo(AuditedFinancialStatementUpload);
