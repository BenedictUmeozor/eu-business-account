...
const PartnershipAgreementUpload = ({
  back,
  next,
}: {
  back: () => void;
  ...
  return (
    <div className="h-full w-full space-y-8 p-8">
      <HeaderTitle
        ...
        headerTitle="Partnership Agreement for voting rights held by the Partners / Ultimate Individual Owners"
      />
      <Form
        layout="vertical"
        autoComplete="off"
...
export default memo(PartnershipAgreementUpload);
